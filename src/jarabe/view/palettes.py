...
class CurrentActivityPalette(BasePalette):
    ...
    def setup_palette(self):
        ...
        menu_item = PaletteMenuItem(_('View Social Help'), 'toolbar-help')
        menu_item.connect('activate', self.__view_social__cb)
    ...
    def __view_social__cb(self, menu_item):
        setup_view_social(self._home_activity.get_bundle_id())
        self.emit('done')
