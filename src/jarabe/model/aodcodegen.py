...
def build_codegen_system_prompt(spec, plan, references=()):
    ...
    return (
        ...
        '- Length: rich activities are typically 400–900 lines of '
        'real working code. Do NOT pad with dead helpers, but do NOT '
        'stop at a 150-line MVP either. If the request is genuinely '
        'simple (single timer, single counter), 250 lines is fine — '
