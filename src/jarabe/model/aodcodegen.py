...
def build_codegen_system_prompt(spec, plan, references=()):
    ...
    return (
        ...
        '- Make the activity full-featured and rich, not minimal. Add '
        'multiple toolbar controls, a sidebar or status area, clear visual '
        'feedback, and enough functionality that a learner can use it for '
        'a real classroom session. Think 200-400 lines of real, working '
        'code — the kind of activity a teacher would actually install and '
        'use with students.\n'
        '- Add helpful UI elements: status labels, color palettes, '
        'instructions, score displays, clear buttons, undo where '
        'appropriate. The activity should feel polished, not bare.\n\n'
