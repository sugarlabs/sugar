...
class PreviewRenderer(Gtk.CellRendererPixbuf):
    ...
    def do_render(self, cr, widget, background_area, cell_area, flags):
        self.props.pixbuf = datastore.get_preview_pixbuf(self._preview_data)
...
class IconView(Gtk.Bin):
    ...
    def __init__(self):
        ...
        self.icon_view.show()
        icon_model = IconModel(self._query)
    ...
    def _thumb_data_func(self, view, cell, store, i, data):
        ...
        cell.props.pixbuf = datastore.get_preview_pixbuf(preview_data)
