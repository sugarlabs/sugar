...
def launch(
    ...
    logging.debug(
        "launch bundle_id=%s activity_id=%s object_id=%s uri=%s",
    ...
    # Check for Python 2 specific indicators
    ...
    activity_handle = ActivityHandle(
        activity_id=activity_id, object_id=object_id, uri=uri, invited=invited
    )
