...
from jarabe.webservice.accountsmanager import find_module, get_webaccount_paths
...
def _get_services():
    ...
    for service_path in service_paths:
        ...
        for folder in folders:
            ...
            mod = load_module(os.path.join(service_path, folder),
                                         'service')
...
def load_module(path, module):
    ...
    try:
        mod = import_module(find_module(path, module), [module])
