        ...
        for bundle_update in updates:
            ...
            if installed:
                ...
                if bundle_update.icon_data is not None:
                    ...
                    icon_file_name = bundle_update.bundle_id.replace('.', '_')
                    icon_file_name = icon_file_name + '.svg'
                    icon_file_name = os.path.join('/tmp', icon_file_name)
                    with open(icon_file_name, mode='w') as iconfile:
                        iconfile.write(bundle_update.icon_data)
                    self._icon_temp_files.append(icon_file_name)
                    row[self.ICON_FILE_NAME] = icon_file_name
